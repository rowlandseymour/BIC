...
:::{.example}
Consider the reaction time data $\boldsymbol{y}$ from Example \@ref{exm:normal}. Again, we assume the $y_i \sim N(\mu, \sigma^2)$, except that this time, we will place a prior distribution on both $\mu$ and $\sigma^2$.
:::
