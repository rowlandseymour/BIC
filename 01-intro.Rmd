...
1. Consider a standard pack of 52 playing cards. You pick a card at random, what is the probability you pick:
...
2. Decide if each of the following events can be assigned probabilities by frequentists: 
    1. The Bermuda triangle exists.
    2. A plan will go missing if it flies into the Bermuda triangle.
    3. Someone will test positive for Covid-19 after contracting the disease. 
    4. The sun will rise tomorrow. 
    
3. An urn contains three coins. Two of the coins are fair, but one of the coins has heads on both sides. 
    1. You pick a coin out of the urn without look and flip it. What's the probability you get heads?
    2. You pick a coin out of the urn without look and flip it and get heads. What's the probability it's the two-headed coin?
  
3. You get an email with the word _bitcoin_ in. You want to work out the probability the email is spam.  
    1. Using the law of total probability, show the probability the email is spam, given it contain the word probability is 
  $$
  ...
  $$
  If an email is known to be spam, there's an 80% chance it contains the word bitcoin. If an email is not spam, then there's a 1% chance it contains the word bitcoin. Calculate the probability the email is spam given it contains bitcoin. 
    3. Suppose you take a much more pessimistic view, and assume that 80% of all emails are spam. Recalculate the probability the email is spam given it contains bitcoin. 

4. You are working on a project investigating pollution related illnesses in the West Midlands. I have sampled the proportion of people with pollution related illnesses in five areas of the West Midlands, $y_1, \ldots, y_5$, with nothing to distinguish the data. 
    1. Should you model these data points exchangeably?
    2. I now tell you four of these rates (0.72, 1.00, 0.85, 0.78 per 100,000). Should you continue to model these data points exchangeably?
    ...
    4. Now suppose I give you the data in part 2 and say that the missing data point is Birmingham City Centre. Should you continue to model these data points exchangeably?
