...
::: {.exercise}  
You get an email with the word _bitcoin_ in. You want to work out the probability the email is spam.  
...
$$
  \pi(\textrm{spam} \mid \textrm{bitcoin}) = \frac{80}{81}
$$
3. This time $\pi(\textrm{spam}) = 0.8$ and $\pi(\textrm{not spam}) = 0.2$, which yields
$$
  \pi(\textrm{spam} \mid \textrm{bitcoin}) = \frac{320}{321}.
$$
:::
