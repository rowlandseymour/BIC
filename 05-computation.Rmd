...
## Data Augmentation
Real world data are often messy with data points missing which may partially or completely unobserved. Two common ways to deal with are:
...
The difference between the two likelihood functions is that the complete data likelihood 
