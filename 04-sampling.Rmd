...
::: {.example}
Recall the lab in the previous chapter, where we had a heiracichal model. The model was given by
\begin{align*}
...
\end{align*}
and the full conditional distributions were
\begin{align*}
\lambda \mid \boldsymbol{y}, \gamma &\sim \textrm{Gamma}(10, 95 + \gamma)\\
\gamma \mid \boldsymbol{y}, \,\lambda &\sim \hbox{Exp}(\lambda + \nu)
\end{align*}
