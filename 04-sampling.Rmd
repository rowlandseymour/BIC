...
#table$x <- c(2.093446, 2.093446, 1.676493, 1.393368, 1.100918, 0.765337)
#table$x <- c(2.45,2.45,1.99,1.672,1.4,1.125,0.8)
table$x <- c(2.325,2.325,1.925,1.63,1.367,1.101,0.785)
table$y <- c(dnorm(table$x[2:7], 0, 1),dnorm(0))

segments(x0 = 0, x1 = table$x, y0= table$y, y1 = table$y)
segments(x0 = table$x[2:7], x1 = table$x[2:7] , y0= table$y[1:6], y1 = table$y[2:7])
#segments(x0 = table$x[1], x1 = 2.5, y0 = table$y[1], y1 = table$y[1])
#segments(x0 = table$x[1], x1 = 2.5, y0 = table$y[1], y1 = table$y[1])
#segments(x0 = 2.5, x1 = 2.5, y0 = 0, y1 = table$y[1])
segments(x0 = 0, x1=5, y0 = 0, y1 = 0)
```
